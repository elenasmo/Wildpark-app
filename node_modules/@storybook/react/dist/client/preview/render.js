  ...
  _createClass(ErrorBoundary, [{
    ...
    value: function componentDidCatch(_ref) {
      var message = _ref.message,
          stack = _ref.stack;
      var showError = this.props.showError; // message partially duplicates stack, strip it
...
function _renderMain() {
  ...
  regeneratorRuntime.mark(function _callee(_ref2) {
    var StoryFn, showMain, showError, forceRender, element;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            StoryFn = _ref2.storyFn, showMain = _ref2.showMain, showError = _ref2.showError, forceRender = _ref2.forceRender;
